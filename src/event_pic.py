...
target_tag = r"event_2025-07-18_000510"
...
def display_comparison(start_img_path: str, stop_img_path: str, view_img_path: str, start_tag: str, stop_tag: str, event_type: str):
    """显示状态转换对比图和视图截图"""
    try:
        # 创建画布
        ...
        ax1.set_title(f"Transition\nStart: {start_tag} → End: {stop_tag}")
        ax1.axis('off')
        ...
        if view_img_path:
            ...
            ax2.imshow(view_img)
            ax2.set_title(f"Triggering View: {event_type}")
            ax2.axis('off')
...
def main():
    ...
    # pic_dir = r"C:\Projects\2025Unicom\output\Unicom_dfs_1\states"
    # view_dir = r"C:\Projects\2025Unicom\output\Unicom_dfs_1\views"


    event_folder = r"C:\Projects\2025Unicom\output\Unicom_dfs\events"
    state_folder = r"C:\Projects\2025Unicom\output\Unicom_dfs\states"
    pic_dir = r"C:\Projects\2025Unicom\output\Unicom_dfs\states"
    view_dir = r"C:\Projects\2025Unicom\output\Unicom_dfs\views"
    ...
    event_type = event_data.get('event')["event_type"]
    ...
    # 7. 显示对比图
    print("正在显示状态转换对比图...")
    display_comparison(start_img, stop_img, view_img, start_tag, stop_tag, event_type)
