...
import copy
import ast
from .parallel_query import MultiProcessingQuery as mpt
...
def parseargs():
    ...
    parser.add_argument('--mode', type=str, required=True, choices=['doc_format', 'task', 'solution', 'format_solution_output'], help='doc_format: format the api paths for raw api document; task: generate tasks for apps; solution: generate solutions for apps')
...
'''
    ...
    def get_all_solution_query_prompts(self, app_name, tasks_path, solution_prompt_path, max_task_per_prompt=8):
...
class FormatOrganizer:
    ...
    @staticmethod
    def form_task_solution_jsonl(solution_prompts_path, solution_json_path, output_jsonl_path):
...
if __name__ == '__main__':
    ...
    if args.mode == 'task':
        ...
        task_generator.generate_prompts('data/tasks/qa_task_0612.json', use_comb=False, ele_group_strides=[2, 4, 6, 8])
        task_generator.query_all_task_prompts('data/tasks/qa_task_0612.json', 'data/tasks/tasks_0612.jsonl', model='gpt-4o')
    if args.mode == 'solution':
        ...
        solution_generator.query_all_solution_prompts(app_name='Notes', tasks_path='data/tasks/tasks_0612.jsonl', solution_prompt_path='data/solutions/solution_prompts_0612.json', solution_answers_path='data/solutions/solution_answers_0612.jsonl', model='gpt-4o')
    
    if args.mode == 'format_solution_output':
        FormatOrganizer.form_task_solution_jsonl('data/solutions/solution_prompts_0612.json', 'data/solutions/solution_answers_0612.jsonl', 'data/notes_train_data0612.jsonl')
