...
POLICY_CODE = 'code_policy' # implemented in input_policy3, used for executing GPT-generated Python code
...
class InputPolicy(object):
    ...
    def start(self, input_manager, code_policy=False):
        """
        ...
        # if code_policy and first_action:
        #     input_manager.add_event(RestartAppEvent(app=self.app))
        while input_manager.enabled and self.action_count < input_manager.event_count:
            try:
                ...
                if self.action_count == 0 and self.master is None and not code_policy:
...
class UtgBasedInputPolicy(InputPolicy):
    ...
    def generate_event(self):
        ...
        # for code_policy, last_event is -1 when we have just finished executing the last action
