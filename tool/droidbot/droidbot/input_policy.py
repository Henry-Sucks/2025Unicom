...
class UtgBasedInputPolicy(InputPolicy):
    ...
    def __if_save_this_current_state(self, last_state, current_state):
        if last_state is None:
            return True
        
        if last_state.structure_str is current_state.structure_str:
            return False
        else:
            return True
    ...
    def generate_event(self):
        ...
        #     self.logger.info("Last state -- views: %s" % last_state.views)
        #     self.logger.info("Last state -- foreground_activity: %s" % last_state.foreground_activity)
        #     self.logger.info("Last state -- activity_stack: %s" % last_state.activity_stack)
        #     self.logger.info("Last state -- background_services: %s" % last_state.background_services)
        

        # self.logger.info("Current state -- views: %s" % current_state.views)
        # self.logger.info("Current state -- foreground_activity: %s" % current_state.foreground_activity)
        # self.logger.info("Current state -- activity_stack: %s" % current_state.activity_stack)
        # self.logger.info("Current state -- background_services: %s" % current_state.background_services)
